...
3. 62.5% is responsive and is basically the same as saying take 62.5% of the default font-size, which is 10px. This makes it easier for us to calculate what we actually want for our design. If we say 2rem then its as simple as doing 10x2 = 20px 
